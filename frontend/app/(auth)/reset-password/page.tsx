			...
			<div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
				<div className="w-full max-w-md">
					...
					<div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
						...
						<h2 className="text-2xl font-bold text-gray-900 text-center mb-4">Success!</h2>
							...
							<div className="flex items-start gap-3">
								...
								<div className="text-sm">
									...
									<p className="text-blue-700">
										Never share your password with anyone and consider enabling two-factor authentication for extra security.
									</p>
								</div>
							</div>
						</div>
					...
					<footer className="text-center mt-8 text-sm text-gray-600">
						...
						<div className="flex justify-center gap-4">
							...
							<a href="/contact" className="hover:text-gray-900 transition-colors">Support</a>
						</div>
					</footer>
				</div>
			</div>
	...
	return (
		<div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
			<div className="w-full max-w-md">
				...
				<form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
					{/* New Password Field */}
					<div className="mb-6">
				...
				<div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
					<div className="flex items-start gap-3">
						...
						<div className="text-sm">
							...
							<p className="text-blue-700">
								Use a unique password that you don't use for other accounts. Consider using a password manager to keep track of your passwords securely.
							</p>
						</div>
					</div>
				</div>
