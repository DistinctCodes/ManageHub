...
import BookingWizard, {
  ...
  type SeatInfo,
} from "@/app/sandbox/components/BookingWizard";
...
function makeAvailData(totalSeats: number, seed: number) {
  return Array.from({ length: 30 }, (_, i) => {
    ...
    return { date: isoDate(i), availableSeats: available };
  });
}

const AVAILABILITY_BY_WORKSPACE: Record<
  string,
  { date: string; availableSeats: number }[]
> = {
...
const SEATS_BY_WORKSPACE: Record<string, SeatInfo[]> = {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Book a Workspace</h1>
          <p className="text-gray-500 text-sm mt-1">
            Follow the steps below to reserve your ideal workspace.
          </p>
        </div>
