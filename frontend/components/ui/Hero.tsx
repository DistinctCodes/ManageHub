...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-background px-6 pt-28 pb-20 overflow-hidden grain">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
        ...
        <div className="fade-in-up max-w-xl">
          <h1 className="text-4xl sm:text-5xl md:text-6xl leading-[1.1] tracking-tight text-foreground mb-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/register"
              className="px-7 py-3.5 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors shadow-sm"
            >
              Get started free
            </Link>
            <Link
              href="#how-it-works"
              className="px-7 py-3.5 rounded-full border border-border text-sm font-medium text-foreground hover:border-foreground/50 transition-colors"
            >
              See how it works
            </Link>
          </div>
        ...
        <div className="fade-in-up-delay-2 relative hidden lg:block">
          <div className="relative ml-8 -mr-12">
            ...
            <div className="absolute -bottom-6 -left-8 bg-card rounded-xl shadow-lg border border-border px-5 py-4 flex items-center gap-3">
              <span className="w-9 h-9 rounded-full bg-blue-100 flex items-center justify-center text-sm">
                +3
              </span>
              <div>
                <p className="text-sm font-medium text-card-foreground">New members</p>
