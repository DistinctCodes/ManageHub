...
import {
  useGetHubSettings,
  BusinessHour,
} from '@/lib/react-query/hooks/admin/settings/useGetHubSettings';
import {
  useUpdateHubSettings,
  UpdateHubSettingsPayload,
} from '@/lib/react-query/hooks/admin/settings/useUpdateHubSettings';
              ...
              <div key={item.day} className="flex items-center gap-6 p-3 rounded-md border">
                ...
                <div className="flex items-center gap-2 ml-auto">
                  <select
                    ...
                    className="h-9 rounded-md border px-3 text-sm disabled:opacity-50 bg-background"
                  >
