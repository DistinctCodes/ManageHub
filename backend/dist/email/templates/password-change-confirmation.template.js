...
exports.getPasswordChangeConfirmationTemplate = void 0;
const getPasswordChangeConfirmationTemplate = (name, year) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
                    ...
                    <tr>
                      <td style="padding: 15px;">
                        <p style="color: #065f46; margin: 0; font-size: 14px; line-height: 1.5;">
                          <strong>✓ Password Updated:</strong> ${new Date().toLocaleString('en-NG', {
        dateStyle: 'long',
        timeStyle: 'short',
...
exports.getPasswordChangeConfirmationTemplate = getPasswordChangeConfirmationTemplate;
//# sourceMappingURL=password-change-confirmation.template.js.map